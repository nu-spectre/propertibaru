    ...
    <PropLayout>
      ...
      {!canPlay ? (
        <div className="max-w-sm mx-auto text-center py-12 space-y-4">
          ...
          <p className="text-sm text-white/40">Saldo kamu saat ini <span className="text-[var(--neon-gold)] font-bold">{fmt(saldo)}</span>. Lakukan deposit terlebih dahulu untuk bermain Slot.</p>
          <button
